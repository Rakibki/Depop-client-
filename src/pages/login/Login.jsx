...
const Login = () => {
  const { loginUser, loginWithGoogle, loginWithGithub, user } =
    ...
    <div>
      <div className="flex w-full md:w-[80%] gap-4 md:gap-6 mx-auto my-16 h-[450px] border-2">
        <div className="md:w-[40%] w-[60%] relative">
          <img className="absolute top-0 w-full h-full" alt="" />
        ...
        <div className="w-[60%] ">
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className="px-5 py-2 mt-4 bg-[#c32929] transition-all  text-white font-bold hover:opacity-80"
              >
                SING IN
              </button>
            </div>
